...
export const ContainerScroll = () => {
  ...
  // Update textKey when activeTab changes to force animation reset
  useEffect(() => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center">
          ...
          <div className="flex flex-col items-center gap-4 md:gap-6">
            ...
            >
              ...
              <div className="h-full w-full overflow-hidden rounded-[35px] bg-gray-100 dark:bg-zinc-900 p-3 md:p-4 flex flex-col items-center justify-center relative">
          ...
          {/* Text Section with Fade Transition */}
          <div className="text-left max-w-md px-4 md:px-0">
            <Typography 
              variant="body1" 
              className="mb-1 md:mb-2 text-sm md:text-base leading-tight"
            >
            ...
            <div 
              ...
              key={textKey} // Use textKey to force animation reset
            >
              <Typography 
                variant="h3" 
                className="textneut text-xl md:text-2xl leading-snug md:leading-normal"
              >
