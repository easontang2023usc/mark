...
const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto p-6 mt-32">
      ...
      <p className="text-gray-700 mb-2">Effective Date: [Jan 1, 2025]</p>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc ml-6">
          <li><strong>Personal Information:</strong> Name, email address, shipping address, phone number, payment information, and account credentials.</li>
          <li><strong>Non-Personal Information:</strong> Browser type, IP address, device information, and browsing activity on our website.</li>
          <li><strong>Cookies and Tracking Technologies:</strong> We use cookies and similar tracking technologies to enhance user experience, analyze trends, and manage our website.</li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc ml-6">
          <li><strong>Service Providers:</strong> Third-party vendors who help us operate our business, including payment processors, shipping partners, and marketing agencies.</li>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc ml-6">
          ...
          <li><strong>Opt-Out of Marketing:</strong> You may opt out of receiving marketing communications from us.</li>
      ...
      <section className="mb-6">
        ...
        <p>We may update this Privacy Policy from time to time. Any changes will be posted on this page with an updated effective date. Your continued use of our website after any modifications constitutes your acknowledgment of the changes.</p>
      </section>
